...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'DiNOV2 training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=16, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='DinoViT_base', type=str, metavar='MODEL',
                        choices=['DinoViT_samll', 'DinoViT_large', 'DinoViT_base', 'DinoViT_giant'],
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'DiNOV2 training and evaluation script', parents=[get_args_parser()])
